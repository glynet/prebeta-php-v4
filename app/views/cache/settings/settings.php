...
<div class="settings-details-container" data-category="1" data-tab="3" data-group="1">
    <div class="container-group">
        ...
        <div class="account-settings account-settings-top-phone-number" style="<?php if ($user['number'] == ''): ?> display: none; <?php endif; ?>">
            <div class="top-title">
                <div class="title">
        ...
        <div class="settings-profile-container">
            <div class="banner-container">
                ...
                <div class="banner edit-profile-mini-profile-banner-area">
                    <?php if ($profile['banner']['type'] == 'image'): ?>
                        <?php if ($profile['banner']['url'] == ''): ?>
            ...
            <div class="container-group-content">
                <label class="switch">
                    <input
                        ...
                        <?php if ($profile['other']['show_joined_date'] == true): ?>
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->hide_profile == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->hide_followings == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->hide_nsfw == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->hide_search_engines == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->find_email == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->find_number == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->public_location_suggestions == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
                    ...
                    <div class="activity-right-side">
                        <div class="text">
                            <div class="title">
                                ...
                                <?php if ($session['current_session'] == true): ?>
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->show_like_count == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($privacy['details']->disable_sharing == 'true'): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
            ...
            <div class="checkmark-container">
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($privacy['details']->comment_options == 'everyone'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($privacy['details']->comment_options == 'only_followings'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($privacy['details']->comment_options == 'only_friends'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($privacy['details']->comment_options == 'only_mentioned'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($privacy['details']->comment_options == 'nobody'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
            ...
            <div class="checkmark-container">
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['language'] == 'tr'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['language'] == 'en'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['language'] == 'az'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['language'] == 'de'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
            ...
            <div class="checkmark-container">
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['region'] == 'africa'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['region'] == 'america'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['region'] == 'asia'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['region'] == 'europe'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['region'] == 'oceania'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
        ...
        <div class="container-group-content">
            <label class="switch">
                <input
                    ...
                    <?php if ($profile['other']['send_notifications'] == true): ?>
                    data-default-value="true"
                    checked="true"
                    <?php else: ?>
                    data-default-value="false"
            ...
            <div class="checkmark-container">
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['data_saving'] == 'wifi_and_mobile_data'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['data_saving'] == 'only_wifi'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"
                ...
                <label class="checkmark-content">
                    ...
                    <input
                        ...
                        <?php if ($profile['other']['data_saving'] == 'never'): ?>
                        data-default-value="true"
                        checked="true"
                        <?php else: ?>
                        data-default-value="false"

<new-details>
    <g-new-title>Explore</g-new-title>
</new-details>

<div class="explore-container">

    <div class="categories-container">
        <div class="categories uiKitDesktop-CategoriesThingSlider"></div>
        <div class="categories-button-container categories-left-button-container uiKitDesktop-CategoriesThingSlider-left-button-container">
            <div @click="ui.desktop.categories.scroll(false)" class="categories-button categories-left-button">
        ...
        <div class="categories-button-container categories-right-button-container uiKitDesktop-CategoriesThingSlider-right-button-container">
            <div @click="ui.desktop.categories.scroll(true)" class="categories-button categories-right-button">
